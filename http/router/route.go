...
import (
	...
	"services/http/controller/article"
	"services/http/controller/baidu"
	"services/http/controller/book"
	"services/http/controller/category"
	"services/http/controller/collect"
	"services/http/controller/comment"
	"services/http/controller/common"
	"services/http/controller/crawler"
	"services/http/controller/keyvalueconfig"
	"services/http/controller/message"
	"services/http/controller/stats"
	"services/http/controller/user"
	"services/http/controller/vote"
